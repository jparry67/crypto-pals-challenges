"""
Set 1: Basics - Challenge 6: Break repeating-key XOR
...
There's a file here (chal6_input.txt). It's been base64'd after being encrypted with repeating-key XOR.
Decrypt it.
Here's how:
...
parser.add_argument("input_file", help="the file with the text to decrypt")
